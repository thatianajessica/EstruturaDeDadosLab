...
void conectarVerticesDirecionado(Grafo *grafo, int index_v1, int index_v2){
...
int main()
{
    ...
    conectarVerticesDirecionado(grafo,0,1);
    conectarVerticesDirecionado(grafo,1,2);
    conectarVerticesDirecionado(grafo,2,4);
    conectarVerticesDirecionado(grafo,3,2);
    conectarVerticesDirecionado(grafo,3,4);
    conectarVerticesDirecionado(grafo,4,0);
    conectarVerticesDirecionado(grafo,5,1);

    printarListasAdj(grafo);

    buscaLargura(grafo,3);
